...
// Outros ícones
const NewsIcon = () => <span>📰</span>;
const PeneirasIcon = () => <span>👥</span>;
const EscolinhasIcon = () => <span>🎓</span>;
...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className="md:hidden flex items-center justify-between p-3 bg-[#7c3fb9] text-white">
