// src/pages/CopaPAB/Competicao2/Fotos.jsx
...
export default function FotosCompeticao2() {
  ...
  useEffect(() => save("c2-photos", photos), [photos]);
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-black mb-4">Fotos • Competição 2</h1>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 rounded-xl px-3 py-2 transition-colors ${
                  selectedTeam === t.name
                    ...
                    : "hover:bg.white/10".replace(".", "/") // Tailwind class safety
                }`}
              >
